...
- [Встановлення пакунків                                            ](#packages)
  ...
  - [Установка менеджера пакунків PackageControl та робота з ним    ](#pcontrol)
...
команд. Команди доступні у файлах з розширенням .sublime-commands, які мають
...
Ctrl+Alt+Shift+P       показує область видимості
...
### Установка менеджера пакунків PackageControl та робота з ним <i id="pcontrol"></i>
