...
- [Установка                                                         ](#install)
  ...
  - [Linux Mint Portable                                         ](#lmp-install)
    -[Особливості версії 4152 в Linux Mint                              ](#4152)
  - [Windows                                                       ](#w-install)
...
#### Особливості версії 4152 в Linux Mint                      <i id="4152"></i>

Якщо у попередній версії 4143 в розпакованій теці був файл програми
`sublime_text` при натисненні на який (за наявності теки Data) відкривалася саме
локальна версія Sublime, то починаючи з версії 4152 файл `sublime_text`
розпізнається Linux як "спільна бібліотека" і редактор не запукає. Натомість
з'явився файл `sublime_text.desktop`, який є якликом, але вказує на не файли в
даній теці, а на глобальні:
...
В даному файлі треба переписати шляхи до файлу `sublime_text` та додати теку
Data і Sublime Text буде портабельним.
...
ліцензією за адресою `/SublimeText4/Data/Local/License.sublime_license`
...
remove       видаляти застарілі префікси
             true
...
1. Увімкнути властивість:
   ```json
   { "enable_autoreload": true}
   ```
2. Виконати команду LiveReload: Enable/disable plug-ins.
3. Вибрати Simple Reload with delay (400ms).
4. Відкрити md-файл у браузері.
...
залежності:  Nоde.js, npm, htmlhint
...
призначення: надає можливість перевіряти правильність синтаксису CSS-стилів
             різних типів файлів
залежності:  Node.js, npm, postcss

Лінтер надає доступ до інтерфейсу stylelint.
...
??? !!!
================================================================================
Trimmer - пакунок для редагування тексту
Require Helper - підказки при підключенні модулів
DocBlockr 2021 (DoxyDoxygen powered) - розширена альтернатива DocBlockr
HyperClick - аналог clickable urls, ніби працює не тільки з модулями, а дофіга чим
================================================================================
не робоче/не актуальне
не працює:
CSS Extended Completions           додавання файлів CSS/SCSS/LESS-файлів в кеш і їх подальше використання в автокомплітах, не працює: меню додається, але постійно не активне
SublimeLinter-contrib-sqlint       не можу поставити rubygem на linux
================================================================================
