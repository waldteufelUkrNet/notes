...
AdvancedNewFile                    зручне створення/видалення/перейменування
                                   файлів і тек
...
Clickable URLs                     підсвітка посилань і можливість їх відкриття
                                   в браузері

Terminal                           дозволяє відкрити термінал через Sublime в
                                   теці поточного документу або кореневій теці проекту
...
PackageResourceViewer              надає інструменти для роботи зі встановленими
                                   пакунками

CommandsBrowser                    надає перелік доступних команд і коротку
                                   документацію по ним
...
Origami                            пакунок дозволяє створювати довільні групи
                                   вкладок і надає зручну по них навігацію

Debugger                           надає інструменти для відлагодження коду

WordCount                          додає в рядок стану інформацію по кількості
                                   слів, сторінок тощо

Clipboard History                  менеджер буферу обміну

Tagify                             дозволяє вставляти мітки в коді py/html/htm/js
                                   і потім виводити список міток у окрему вкладку.
                                   Мітки і список мов можна розширювати.

Random Everything                  генерування випадкових значень: пошт, дат тощо

Inc-Dec-Value                      збільшення/зменшення цифр, кольорів, букв в
                                   словах на великі/малі, true на false тощо.
                                   Можна створити власний словник замін.
...
nginx                              підсвітка синтаксису конфігураційних файлів
                                   Nginx
...
StyleToken                         підсвітка довільних фрагментів коду для
...
HTML-CSS-JS Prettify               вирівнювання відступів у файлах HTML/CSS/JS/
                                   JSON/React/JSX/Vue, демініфікує мініфіковані
                                   файли

Alignment                          вирівнювання пари ключ-значення CSS/JS/JSON
                                   по розділовому знаку

AlignTab                           вирівнювання тексту за допомогою регулярок,
                                   доступна опція табличного вирівнювання

Markdown Table Formatter           вирівнювання таблиць у файлах markdown

JsPrettier                         Вирівнювання коду багатьох мов у стилі, який
                                   використовує Prettier (https://prettier.io)


##### Підказки

All Autocomplete                   робить підказки, спираючись на усі відкриті
                                   файли

AutoFileName                       робить підказки для шляхів і назв файлів при
                                   їх підключенні

Nodejs                             підказки для Node.js + команди для запуску
                                   рушія

jQuery                             підказки-автокомпліти для jQuery

SublimeCodeIntel                   авокомпліти стандартних функцій багатьох мов
                                   програмування + у контекстному меню перехід у
                                   файл / на рядок з оголошенням функції


##### Перевірка коду (лінтери)

SublimeLinter                      фреймворк для перевірки синтаксису коду, не
                                   має власних лінтерів

SublimeLinter-json                 перевірка синтаксису JSON

SublimeLinter-pug-lint             перевірка синтаксису Pug

SublimeLinter-stylelint            перевірка синтаксису CSS/SCSS/Sass/Less/
...
SublimeLinter-annotations          comments such as FIXME, NOTE, TODO, @todo,
...
FileDiffs                          порівняння файлів і пошук у них відмінностей

Git                                додає в редактор основні команди Git

SideBarGit                         додає в контекстне меню файлів/тек пункт "Git"

Git Gutter                         підсвічує змінені рядки, видає по них коротку
                                   інформацію, виводить попап з порівнянням змін

gist                               надає доступ до гістів з GitHub

Sublimerge3                        надає можливість порівнювати версії файлів і
                                   вирішувати конфлікти злиття


##### Різне

CSSComb                            сортування властивостей у заданій
                                   послідовності у файлах css/scss/sass/less

Console Wrap                       створення і робота з логуючими виразами в
                                   Python/JS/PHP/Go

HTML Minifier                      мініфікатор HTML/CSS/JS. Може зберегти
                                   результат у поточний файл або створити новий
                                   з префіксом .min

HTML Nest Comments                 в стандартному HTML не можна закоментувати
...
Goto-CSS-Declaration               пошук css-декларацій у відкритих файлах
                                   css/scss/sass/less

DocBlockr                          створення коментарів у форматі DocBlock для
                                   JS/PHP/CoffeeScript/Actionscript/TypeScript/
                                   C/C++/Objective C/Haxe/Java/Apex/Groovy/Rust

Autoprefixer                       додає вендорні префікси в CSS/SCSS

MarkdownPreview                    показує в браузері, як виглядає md-файл. Має
                                   інтеграцію з LiveReload

Markdown HTML Preview              відкриває браузер і показує, як виглядає
                                   md-файл

ClickableRequires                  дозволяє швидко відкрити імпортовані модулі
                                   (required/imported) javascript/typescript/
                                   coffeescript

EditorConfig                       стандартизація синтаксису в проектах, які
                                   ведуть різні розробники з різними IDE

PlainTasks                         організація todo-листів

Tag                                набір пакетів для роботи з HTML

Table Editor                       дозволяє зручно створювати і корегувати
                                   текстові таблиці

MarkdownEditing                    надає засоби для роботи з markdown

Emmet                              дозволяє створювати розмітку за скороченими
                                   інструкціями у більшості популярних
                                   розширенях файлів
